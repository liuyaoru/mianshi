    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        <el-upload
          class="upload-demo"
          ref="upload"
          action="http://localhost:88/api/product/brand/uploadFile"
          :on-preview="handlePreview"
          :on-remove="handleRemove"
          :file-list="fileList"
          :auto-upload="false">
          <el-button slot="trigger" size="small" type="primary">选取excel文件</el-button>
          <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传excel文件</el-button>
<!--          <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>-->
    ...
    <el-dialog title="关联分类" :visible.sync="cateRelationDialogVisible" width="30%">
      <el-popover placement="right-end" v-model="popCatelogSelectVisible">
        ...
        <el-button @click="getCategorys" slot="reference">新增关联</el-button>
      </el-popover>
      ...
      if (brandId) {
        this.$http({
          url: this.$http.adornUrl(
            `/product/attrgroup/info/${brandId}`
          ),
          method: "get",
